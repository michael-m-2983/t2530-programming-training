...
public class Blocks {
    ...
    public void generate() {
        block[0][0] = 750; block[0][1] = defY; block[0][2] = 1;
        ...
        for(int i=1; i<100; i++) {
            ...
            // testing stuff
            block[i][0] = block[i-1][0]+20; block[i][2] = 1;
            i+=1;

            block[i][0] = block[i-1][0]+20; block[i][1] = defY; block[i][2] = 0;
            i+=1;
            block[i][0] = block[i-1][0]+20; block[i][1] = defY; block[i][2] = 0;
            i+=1;
            block[i][0] = block[i-1][0]+20;block[i][1] = defY; block[i][2] = 0;
